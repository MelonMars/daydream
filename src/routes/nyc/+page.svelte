<script lang="ts">
	...
	const EVENT_GOOGLEMAPS = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3021.982808302347!2d-74.0466896845921!3d40.68924997933543!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x5f1c8f86f5cb4866!2sStatue%20of%20Liberty!5e0!3m2!1sen!2sus!4v1654806476855!5m2!1sen!2sus";

	const EVENT_SPONSORS = ["Your Company", "Another Sponsor", "And Another"];
...
<div class="flex flex-col items-center justify-center h-screen text-center bg-gradient-to-b from-[#CCF4FD] to-[#B8D9F8] bg-blend-overlay relative">
	...
	<div class="absolute top-32 left-0 w-full h-full pointer-events-none overflow-hidden z-4">
		<svg width="1280" height="600" viewBox="0 0 1280 600" class="w-full h-full object-contain" xmlns="http://www.w3.org/2000/svg">
			<defs>
				<path id="sponsors-path" d="M-80 120C60 120 140 140 260 160C420 190 490 220 640 240C790 260 860 280 1020 300C1180 320 1260 340 1320 360L1320 380C1260 400 1180 420 1020 440C860 460 790 480 640 500C490 520 420 540 260 560C140 580 60 600 -80 600"/>
				<mask id="sponsors-reveal-mask">
					<rect x="0" y="0" width="0" height="600" fill="white">
						<animate attributeName="width" values="0;1280" dur="2.5s" calcMode="spline" keySplines="0.05,0.7,0.3,1" keyTimes="0;1" begin="1.5s" fill="freeze"/>
					</rect>
				</mask>
			</defs>
			<g mask="url(#sponsors-reveal-mask)">
				<path d="M-80 120C60 120 140 140 260 160C420 190 490 220 640 240C790 260 860 280 1020 300C1180 320 1260 340 1320 360L1320 380C1260 400 1180 420 1020 440C860 460 790 480 640 500C490 520 420 540 260 560C140 580 60 600 -80 600" 
					  stroke="#FF8C42" stroke-width="32" fill="none" stroke-linecap="round"/>
				<text font-family="sans-serif" fill="#FFF5E6" font-weight="bold" font-size="16" 
					  dominant-baseline="middle" text-anchor="start">
					<textPath href="#sponsors-path" startOffset="0%">
						{@html Array(10).fill(EVENT_SPONSORS.join(" • ")).join(" • ") + " • "}
						<animate id="sponsors-animation" attributeName="startOffset" values="-120%;20%" dur="35s" repeatCount="indefinite"/>
					</textPath>
				</text>				
			</g>
		</svg>
